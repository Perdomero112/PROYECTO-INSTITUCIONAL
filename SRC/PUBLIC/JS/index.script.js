// Biblioteca Institucional - Script Principal
document.addEventListener('DOMContentLoaded', function() {
    // Inicializar funciones cuando el DOM esté listo (modal lo maneja base.script.js)
    setupSelectNavigation();
    setupAnimations();
});

// (El modal de perfil lo maneja globalmente /JS/base.script.js)

// Menú móvil: manejado globalmente en /JS/base.script.js
